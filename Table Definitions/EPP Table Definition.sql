CREATE sequence IF NOT exists epp_recno_seq;


CREATE TABLE IF NOT EXISTS public.epp
(
    recno bigint NOT NULL DEFAULT nextval('epp_recno_seq'::regclass),
    entity_id integer,
    ...
    CONSTRAINT epp_pkey PRIMARY KEY (recno),
    CONSTRAINT "Duplicate_EPP" UNIQUE (entity_id, task_id, complete_date)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS public.epp
    OWNER to postgres;

-- Trigger: update_edit_timestamp

-- DROP TRIGGER IF EXISTS update_edit_timestamp ON public.epp;
