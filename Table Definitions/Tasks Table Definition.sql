CREATE sequence IF NOT exists tasks_recno_seq;
...
(
    ...
    CONSTRAINT tasks_pkey PRIMARY KEY (recno),
    CONSTRAINT "Duplicate_Tasks" UNIQUE (entity_id, task_id, complete_date)
)
...
-- DROP TRIGGER IF EXISTS update_edit_timestamp ON public.tasks;
